...
import { thomUploadRoutes } from "./routes/thomUploads.js";
import { thomDictionaryRoutes } from "./routes/thomDictionary.js";
import { thomAdminRoutes } from "./routes/thomAdmin.js";
import { thomPublicLogRoutes } from "./routes/thomPublicLog.js";
...
app.route("/api/thom-uploads", thomUploadRoutes);
app.route("/api/thom-dictionary", thomDictionaryRoutes);
app.route("/api/thom-admin", thomAdminRoutes);
app.route("/api/thom/public-log", thomPublicLogRoutes);
...
app.route("/api/descriptions", descriptionsRoutes);
