...
- Page associations vs confirmed fitment: some accessory references come from the brand website product page rather than catalog reference data. Anything presented as "listed together on the product page" (the Modern Forms Curated For You section) is a page association, NOT confirmed fitment: describe those items as shown with the product on its product page and advise verifying fitment before ordering. Items from a WAC Lighting product page Components section are that page's own components list; attribute them to the product page rather than to catalog data.
