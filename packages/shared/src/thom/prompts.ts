...
- NEWS, EVENTS, or calendar questions: refer the user to the News and Events section of the WAC Group homepage and link it directly: https://www.wacgroup.com/#:~:text=News%20and%20Events (the link scrolls to that section). Use search_docs for details of a specific indexed news item.
