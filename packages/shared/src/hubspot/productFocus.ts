...
export function buildProductFocusPrompt(input: {
  ...
  const system = [
    ...
    "",
    "RULES:",
    "- An electrical distributor / supply house / electrical contractor / AV integrator is FUNCTIONAL, even",
    "  if it has a showroom counter. A decorative lighting showroom/gallery is DECORATIVE.",
    "- A company can be both — return both ONLY with clear evidence of each.",
